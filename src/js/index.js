/*
        ...
        - passo 1.1 - pegar no JS o elemento HTML correspondente ao botão de troca de tema
        - passo 1.2 - dar um jeito de pegar no JS o elemento HTML corresponde ao body
        - passo 1.3 - dar um jeito de identificar o clique do usuário no botão de troca de tema
        - passo 1.4 - adicionar a classe modo-escuro no body
        - passo 1.5 - trocar a imagem do botão de alterar tema pra lua
        ...
        - passo 2.1 - verificar se o body já tem a classe modo-escuro
        - passo 2.2 - remover a classe do modo-escuro do body
        - passo 2.3 - trocar a imagem do botão de alterar tema pra sol
*/
